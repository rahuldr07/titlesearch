 ...
 *
 * CONTRACT GAP: the design also draws Conflict and Open pills. Both are
 * provenance facets (`RuleProvenance`), and `Rule` carries `origin`, not a
 * provenance tag — so neither can be populated or filtered. They are absent
 * rather than rendered empty: a pill reading "Conflict · 0" asserts there are
 * no conflicts, which is not something this client knows.
 *
