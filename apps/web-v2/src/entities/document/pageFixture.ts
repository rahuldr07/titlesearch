...
const PAPER = "#f8f3e4"; // rules-allow: data-URI SVG has no CSS context; mirrors --color-surface-paper
const INK = "#33291b"; // rules-allow: data-URI SVG has no CSS context; mirrors --color-page-ink
const SCAN_INK = "#3a3020"; // rules-allow: data-URI SVG has no CSS context; mirrors --color-scan-ink
const RULE_LINE = "#d5cdb6"; // rules-allow: data-URI SVG has no CSS context; mirrors --color-scan-line
