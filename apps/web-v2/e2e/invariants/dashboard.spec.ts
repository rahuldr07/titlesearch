...
test("a backlog row opens its server-authored drill-down", async ({ page }) => {
  ...
  // SELECTOR REWRITE 2026-07-28: the close control is named "Close", not "×".
  // A screen reader announcing "multiplication sign, button" tells nobody
  // anything; the glyph is decorative and the label carries the meaning.
  // Assertion unchanged — the drawer must still close.
