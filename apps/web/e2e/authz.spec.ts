...
/**
 * The authz table enforced END-TO-END: the same permission data gates the
 * UI's affordances AND the mock server's mutations (x-mock-role stands in
 * for the Clerk JWT claim), so frontend gating cannot drift from server
