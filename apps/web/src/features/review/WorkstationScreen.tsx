...
export function WorkstationScreen(props: {
  ...
  /*
   * Double-click is NOT gated to the queue, deliberately: it is the override
   * for correcting a field the pipeline settled, and it grants the selection
   * `onSelect` refuses. Reachability only — see docs/adr/0002-double-click-override.md.
   */
