    ...
    <div className="flex flex-col gap-6">
      <div className="border-b border-line-subtle pb-5">
        ...
        <p className="pt-2 font-sans text-label leading-close text-ink-muted">
          Each block declares output strings for all four absence states — never
          collapsed into one dash.
        </p>
      </div>
      {block.na_matrix === null ? (
        <p className="font-sans text-label leading-body text-ink-muted">
          This block declares no absence strings — its structure is locked by the
          product rule and always present.
        </p>
      ) : (
        NA_MODES.map((mode) => (
          <div
