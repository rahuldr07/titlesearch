...
| `TRUST-MODEL.md` | AUTHORITATIVE | Who can defeat which database guarantee, and what would notice. Measured 2026-09-08. **Read before writing "cannot", "immutable", "append-only" or "tamper-proof" anywhere** |
